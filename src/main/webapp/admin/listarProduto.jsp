...
<body>
		...
		<div class="offcanvas-body p-0">
			<nav class="navbar-dark">
				<ul class="navbar-nav">
					...
					<li><a href="#" class="nav-link px-3 active"> <span
					...
					<li><a class="nav-link px-3 sidebar-link"
						data-bs-toggle="collapse" href="#layouts"> <span class="me-2"><i
								class="bi bi-layout-split"></i></span> <span>Layouts</span> <span
					...
					<li><a href="#" class="nav-link px-3"> <span class="me-2"><i
								class="bi bi-graph-up"></i></span> <span>Charts</span>
					</a></li>
					<li><a href="#" class="nav-link px-3"> <span class="me-2"><i
								class="bi bi-table"></i></span> <span>Tables</span>
					</a></li>
				</ul>
			</nav>
		</div>
	...
	<main class="mt-5 pt-3">
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-12">
					<a class="btn btn-danger" href="novoProduto.html">Novo Produto</a>
				</div>
			</div>
				...
				<div class="col-md-12 mb-3">
					<div class="card">
						<div class="card-header">
							<span><i class="bi bi-table me-2"></i></span> Listar Todos os
							Produtos
						</div>
						<div class="card-body">
							<div class="table-responsive">
								<table id="example" class="table table-striped data-table"
									...
									<tbody>
										...
										<tr>
											<td><%= listaProdutos.get(i).getCodProduto() %></td>
											<td><%=listaProdutos.get(i).getNome()%></td>
											<td><%=listaProdutos.get(i).getDescricao()%></td>
											<td><%=listaProdutos.get(i).getCodigo()%></td>
											<td><%=listaProdutos.get(i).getPreco()%></td>
											<td><%=listaProdutos.get(i).getCategoria()%></td>
											<td><%=listaProdutos.get(i).getQuantidade()%></td>
										</tr>
										<%} %>
									</tbody>
