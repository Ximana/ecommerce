...
<%
DAO dao = new DAO();
ArrayList<Carrinho> carrinho = (ArrayList<Carrinho>) request.getAttribute("carrinho");
...
<body>
	...
	<div class="container py-5">
		<div class="row">
			...
			<h1>Itens no carrinho de compras</h1>
			...
			<table class="table table-striped">
				...
				<%
					...
					%>
					<tr>
						<td scope="row"><%=carrinho.get(i).getCodProduto()%></td>
						<td><%=carrinho.get(i).getNome()%></td>
						<td><%=carrinho.get(i).getDescricao()%></td>
						<td><%=carrinho.get(i).getPreco()%></td>
						<td><%=carrinho.get(i).getCategoria()%></td>
						<td><%=carrinho.get(i).getQuantidade()%></td>
						<td><%=carrinho.get(i).getData()%></td>
						<td><%=carrinho.get(i).getHora()%></td>
						<td><a href="removerCarrinho?idItemPedido=<%=carrinho.get(i).getCodItemPedido()%>" class="btn btn-danger btn-sm">Remover </a></td>
					</tr>
					<%
					}
					%>
			...
			<a class="btn btn-danger form-control" href="compra?idUsuario=<%=idUsuario%>">Comprar itens do carrinho</a>
