...
<%
DAO dao = new DAO();
ArrayList<Produto> listaProdutos = dao.listarProduto();//Carrega todos os produtos
			...
			<div
				...
				<div class="flex-fill">
					<ul
						...
						if (login) {
						%>
						<li class="nav-item"><a class="nav-link" href="verFavorito?idUsuario=<%=idUsuario%>">Favoritos</a>
						</li>
						<%
						}
						%>
						...
						<div class="col-lg-6 mb-0 d-flex align-items-center">
							<div class="text-align-left align-self-center">
								<h1 class="h1 text-success">
									<b>Luanda</b> eCommerce
								</h1>
								<h3 class="h2">O cliente Ker, cliente manda!</h3>
								<p>
	...
	<section class="container py-5">
		...
		<div class="row">
			<div class="col-12 col-md-4 p-5 mt-3">
				...
				<h5 class="text-center mt-3 mb-3">Relogio</h5>
				<p class="text-center">
			...
			<div class="col-12 col-md-4 p-5 mt-3">
				<a href="#"><img src="./assets/img/category_img_02.jpg"
					class="rounded-circle img-fluid border"></a>
				<h2 class="h5 text-center mt-3 mb-3">Calçaos</h2>
				<p class="text-center">
					<a class="btn btn-success">Comprar</a>
				</p>
			</div>
	...
	<section class="bg-light">
		<div class="container py-5">
			<div class="row text-center py-3">
				<div class="col-lg-6 m-auto">
					<h1 class="h1">Produtos em Destaques</h1>
					...
					<div class="card h-100">
						...
						<div class="card-body">
							<ul class="list-unstyled d-flex justify-content-between">
								...
								<li class="text-muted text-right">240.00 kz</li>
							</ul>
						...
						<div class="card-body">
							<ul class="list-unstyled d-flex justify-content-between">
								<li><i class="text-warning fa fa-star"></i> <i
									...
									class="text-muted fa fa-star"></i> <i
									class="text-muted fa fa-star"></i></li>
								<li class="text-muted text-right">480.00 kz</li>
							</ul>
							<a href="shop-single.html"
								class="h2 text-decoration-none text-dark">Acessorios</a>
					...
					<div class="card h-100">
						...
						<div class="card-body">
							<ul class="list-unstyled d-flex justify-content-between">
								...
								<li class="text-muted text-right">360.00 kz</li>
							</ul>
							<a href="shop-single.html"
								class="h2 text-decoration-none text-dark">Relogio</a>
