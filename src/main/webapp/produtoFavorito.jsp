...
<%
ArrayList<Produto> listaProdutos = (ArrayList<Produto>) request.getAttribute("listaFavoritos");
						...
						<div class="card mb-4 product-wap rounded-0">
							<div class="card rounded-0">
								<img class="card-img rounded-0 img-fluid"
									src="assets/img/produtos/<%=listaProdutos.get(i).getImagem()%>">
								<div
									class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
									<ul class="list-unstyled">
										<li><a class="btn btn-success text-white"
											href="produtoSelecionado?codigoProduto=<%=listaProdutos.get(i).getCodProduto()%>"><i class="far fa-heart"></i></a></li>
										<li><a class="btn btn-success text-white mt-2"
											href="produtoSelecionado?codigoProduto=<%=listaProdutos.get(i).getCodProduto()%>"><i class="far fa-eye"></i></a></li>
										<li><a class="btn btn-success text-white mt-2"
											href="produtoSelecionado?codigoProduto=<%=listaProdutos.get(i).getCodProduto()%>"><i class="fas fa-cart-plus"></i></a></li>
									</ul>
								</div>
							</div>
							<div class="card-body">
								<a href="produtoSelecionado?codigoProduto=<%=listaProdutos.get(i).getCodProduto()%>" class="h3 text-decoration-none"><%=listaProdutos.get(i).getNome()%></a>
								<ul
									class="w-100 list-unstyled d-flex justify-content-between mb-0">
									<li><%=listaProdutos.get(i).getCategoria()%></li>
									<li class="pt-2"><span
								...
								<p class="text-center mb-0"><%=listaProdutos.get(i).getPreco()%>
									kz
								</p>
							</div>
						</div>
